...
class Services_Soundcloud
{
    ...
    protected function _request($url, $curlOptions = array())
    {
        ...
        if ($this->_validResponseCode($this->_lastHttpResponseCode)) {
            ...
            $error = new Services_Soundcloud_Invalid_Http_Response_Code_Exception(
                null,
                0,
			...
			$return['error'] = 1;
			$return['lastHttpResponseCode'] = $this->_lastHttpResponseCode;
			$return['lastHttpResponseBody'] = $this->_lastHttpResponseBody;
